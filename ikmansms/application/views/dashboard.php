...
<!-- Mirrored from themesbrand.com/minia/layouts/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Sep 2021 08:02:11 GMT -->
<head>
    ...
    <!-- <body data-layout="horizontal"> -->
      ...
      <?php include __DIR__.'left_side_bar.php'; ?>

        <!-- Right bar overlay-->
        <div class="rightbar-overlay"></div>

        <!-- JAVASCRIPT -->
        <script src="<?php include __DIR__.?>assets/libs/jquery/jquery.min.js"></script>
        <script src="<?php include __DIR__.?>assets/libs/bootstrap/js/bootstrap.bundle.min.js"></script>
        <script src="<?php include __DIR__.?>assets/libs/metismenu/metisMenu.min.js"></script>
        <script src="<?php include __DIR__.?>assets/libs/simplebar/simplebar.min.js"></script>
        <script src="<?php include __DIR__.?>assets/libs/node-waves/waves.min.js"></script>
        <script src="<?php include __DIR__.?>assets/libs/feather-icons/feather.min.js"></script>
        <!-- pace js -->
        <script src="<?php include __DIR__.?>assets/libs/pace-js/pace.min.js"></script>

        <!-- apexcharts -->
        <script src="<?php include __DIR__.?>assets/libs/apexcharts/apexcharts.min.js"></script>
...
<!-- Mirrored from themesbrand.com/minia/layouts/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 04 Sep 2021 08:02:13 GMT -->
</html>